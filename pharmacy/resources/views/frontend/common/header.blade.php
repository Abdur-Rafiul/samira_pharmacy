    ...
    <nav id="main-navbar" class="navbar navbar-expand-lg navbar-light bg-white fixed-top">
      ...
      <div class="container-fluid">
        ...
        <a class="navbar-brand nav-link" href="#">
            <img class="logo" src="photo/medicine.png" alt=""><br>
            <span class="text-danger d-flex">For better health</span>
        </a>
    </li>
        <li class="nav-item">
            <a class="nav-link ms-5 navbar-brand" href="#"><h4>Online Pharmacy</h4></a>
            <span class="nav-link navbar-brand"><img class="delivery-logo" src="photo/delivery.png" alt=""> Deliver to Bangladesh</span>
          </li>
        <!-- Search form -->
        ...
        <ul class="navbar-nav ms-auto d-flex flex-row">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link me-3 me-lg-0 dropdown-toggle hidden-arrow" href="#" id="navbarDropdownMenuLink"
              ...
              <img class="user-logo" src="photo/user.png" alt="">
          ...
          <li class="nav-item">
            <a class="nav-link me-3 me-lg-0" href="#">
                <img class="cart-logo" src="photo/cart.png" alt="">
            </a>
          </li>
